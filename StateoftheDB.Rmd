...
```{r plotSites, echo=FALSE, warning=FALSE}
...
The main APIs delivered a total of `r p(floor(sum(as.numeric(apiOut$contentlength), na.rm=TRUE) /1000000))` MB of data to users over the last year, with the most significant payload beginning in approximately October 2020.
...
```{r modifyTiliaLog, echo=FALSE, message=FALSE, warning=FALSE}
stewardLog <- tiliaLog %>% 
