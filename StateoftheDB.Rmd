...
This report largely details changes to the database since **`r lastdate`**, and is current up to **`r lubridate::today()`**. 
...
DT::datatable(outtable, 
  caption = htmltools::tags$caption(
    ...
    "Table 1: ", htmltools::em("Database contributions over the prior 12 months for the Neotoma Paleoecology Database.")
  ),
